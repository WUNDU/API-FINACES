...
public class CreditCardController {
        ...
        public ResponseEntity<CreditCardResponseDTO> addCreditCard(
                        @Parameter(description = "User ID", required = true, example = "b28906bf-561b-4b61-9bd4-fd7c23eec23f") @PathVariable String userId,
                        @Parameter(description = "Credit Card data for creation", required = true) @Valid @RequestBody CreditCardCreateDTO create) {
        ...
        public ResponseEntity<CreditCardResponseDTO> getCreditCard(
                        @Parameter(description = "Credit Card ID", required = true, example = "b28906bf-561b-4b61-9bd4-fd7c23eec23f") @PathVariable String id) {
